...
return [
    ...
    */
    ...
    'twitter' => env('COMPANY_TWITTER', 'Laravel'),
    'facebook' => env('COMPANY_FACEBOOK', 'Laravel'),
    'google_plus' => env('COMPANY_GOOGLE_PLUS', 'Laravel'),
    'linked_in' => env('COMPANY_LINKED_IN', 'Laravel'),
    'youtube' => env('COMPANY_YOUTUBE', 'Laravel'),
];
