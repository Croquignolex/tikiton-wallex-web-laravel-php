    ...
    <tr>
        <td>
            ...
            <div style="text-align: center;">
                <a href="{{ $user->confirmation_link }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0 30px; font-size: 15px; color: #fff; background: #777777; text-decoration:none;" target="_blank">
