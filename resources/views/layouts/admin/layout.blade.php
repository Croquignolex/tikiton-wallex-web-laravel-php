...
@push('style.page')
    ...
    <link rel="stylesheet" href="{{ css_admin_asset('style') }}" type="text/css">
    <link rel="stylesheet" href="{{ css_admin_asset('responsive') }}" type="text/css">
...
@push('script.page')
    ...
    <script src="{{ js_admin_asset('script') }}" type="text/javascript"></script>
