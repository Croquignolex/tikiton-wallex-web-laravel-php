...
@section('breadcrumb.app.layout.title', page_title(trans('general.transfers_report')))

@section('breadcrumb.title', trans('general.transfers_report'))
                    ...
                    <div class="text-center col-xs-12">
                        <div class="pagination">
                            <a data-toggle="popover" data-placement="left" data-content="{{ $transactionService->getDateRangeChanger($date_range - 1, $type)->last() }}"
                               href="{{ $transactionService->getDateRangeChanger($date_range - 1, $type, locale_route('transactions.transfer.report'))->first() }}" class="btn btn-primary" data-trigger="hover">
