        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                            ...
                            'title' => trans('general.daily_transfer_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.weekly_transfer_chart'),
                           'title_date' => $transactionService->getDayFormatDate(now()),
                ...
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.monthly_transfer_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.yearly_transfer_chart'),
                           'title_date' => now()->year,
                ...
                <div class="col-xs-12">
                    @component('components.app.dashboard-chart', [
                       'report_route' => locale_route('transactions.transfer.report') . '?type=' . \App\Models\Transaction::WEEKLY,
                       'title' => trans('general.details_daily_transfer_chart'),
                ...
                <div class="col-xs-12">
                    @component('components.app.dashboard-chart', [
                       'report_route' => locale_route('transactions.transfer.report') . '?type=' . \App\Models\Transaction::YEARLY,
                       'title' => trans('general.details_yearly_transfer_chart'),
                       'title_date' => now()->year,
