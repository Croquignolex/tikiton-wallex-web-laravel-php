...
@section('app.layout.title', page_title(trans('general.incomes')))
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    @component('components.app.dashboard-widget', [
                        'name' => trans('general.daily_income'),
                        'id' => 'daily-widget',
                        'value' => $daily,
                        'route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::DAILY,
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    @component('components.app.dashboard-widget', [
                        'name' => trans('general.weekly_income'),
                        'id' => 'weekly-widget',
                        'value' => $weekly,
                        'route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::WEEKLY,
                        'symbol' => $currency->symbol,
                        'color' => 'text-success'
                    ])
                    @endcomponent
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    @component('components.app.dashboard-widget', [
                        'name' => trans('general.monthly_income'),
                        'id' => 'monthly-widget',
                        'value' => $monthly,
                        'route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::MONTHLY,
                        'symbol' => $currency->symbol,
                        'color' => 'text-success'
                    ])
                    @endcomponent
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    @component('components.app.dashboard-widget', [
                        'name' => trans('general.yearly_income'),
                        'id' => 'yearly-widget',
                        'value' => $yearly,
                        'route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::YEARLY,
                        'symbol' => $currency->symbol,
                        'color' => 'text-success'
                    ])
                    @endcomponent
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                            'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::DAILY,
                            'title' => trans('general.current_day_income_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::WEEKLY,
                           'title' => trans('general.current_week_income_chart'),
                           'title_date' => $transactionService->getDayFormatDate(now()),
                ...
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::MONTHLY,
                           'title' => trans('general.current_month_income_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::YEARLY,
                           'title' => trans('general.current_year_income_chart'),
                           'title_date' => now()->year,
                ...
                <div class="col-xs-12">
                    @component('components.app.dashboard-chart', [
                       'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::WEEKLY,
                       'title' => trans('general.current_week_days_income_chart'),
                ...
                <div class="col-xs-12">
                    @component('components.app.dashboard-chart', [
                       'report_route' => locale_route('transactions.income.report') . '?type=' . \App\Models\Transaction::YEARLY,
                       'title' => trans('general.current_year_months_income_chart'),
                       'title_date' => now()->year,
...
@push('app.layout.script.page')
    ...
    <script src="{{ js_app_asset('incomes-dashboard') }}" type="text/javascript"></script>
