                ...
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                            ...
                            'title' => trans('general.daily_income_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.weekly_income_chart'),
                           'title_date' => $transactionService->getDayFormatDate(now()),
                ...
                <div class="col-xs-12">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.monthly_income_chart'),
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        @component('components.app.dashboard-chart', [
                           ...
                           'title' => trans('general.yearly_income_chart'),
                           'title_date' => now()->year,
