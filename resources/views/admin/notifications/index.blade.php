...
@section('breadcrumb.admin.layout.title', admin_page_title(trans('general.notifications')))

@section('breadcrumb.title', trans('general.notifications'))

@section('breadcrumb.message')
    <a href="{{ route('admin.notifications.index') }}">@lang('general.notifications')</a>
    ...
    @foreach($paginationTools->displayItems as $notification)
        @if($notification->authorised)
            @component('components.modal', [
                ...
                'action_route' => route('admin.notifications.destroy', [$notification])
                ])
