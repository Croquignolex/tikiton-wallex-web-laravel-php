...
@section('breadcrumb.message')
    <a href="{{ route('admin.account.index') }}">{{ text_format($user->format_full_name, 50) }}</a>
@endsection
                            ...
                            <form action="" method="POST" @submit="validateFormElements">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'address'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'address',
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'post_code'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'post_code',
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'phone'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'phone',
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'city'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'city',
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'country'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'country',
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'profession'])
                                                <div class="nk-int-st">
                                                    @component('components.input', [
                                                       'name' => 'profession',
                                        ...
                                        <div class="form-group">
                                            @component('components.admin.label-input', ['name' => 'description'])
                                                <div class="nk-int-st">
