...
<div class="progress">
    ...
    <div class="progress-bar progress-bar-striped progress-bar-info active" role="progressbar" style="width: {{ $transfersPercent }}%" data-content="@lang('general.transfers')" data-trigger="hover" data-toggle="popover" data-placement="bottom">{{ $transfersPercent }}%</div>
