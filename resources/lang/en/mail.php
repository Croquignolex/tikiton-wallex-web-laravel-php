...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mail page Language Lines
    |--------------------------------------------------------------------------
    |
    | The following mail lines are used during home page for various
    ...
    */
    ...
    'body_register_msg' => 'On :date, you have created an account and the system wish to
        validate your email address. If you did not make this action, simply ignore this
